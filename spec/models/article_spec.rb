...
RSpec.describe Article, type: :model do
  describe '#validations' do
    ...
    it 'has an invalid title' do
      ...
      expect(article.errors[:title]).to include("can't be blank") #inlcuding an error message
    end
    ...
    it 'validates the uniqueness of the slug' do
      ...
      article2 = create(:article, slug: article1.slug)
  ...
  describe '.recent' do
    it 'returns articles from most recent to oldest' do
